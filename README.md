**planckreset** is quite possibly the smallest CSS reset in the universe. At only *81 bytes*, simply copy and paste the planckreset code snippet at beginning of your CSS.
